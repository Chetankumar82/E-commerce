...
const CheckoutPage = () => {
   ...
   const [openAdddress,setOpenAddress] = useState(false)
  ...
  return (
    ...
    <div className='container mx-auto p-4 flex w-full gap-5 justify-between flex-col lg:flex-row'>
      <div className='w-full '>
            ...
            <div onClick={()=>setOpenAddress(true)} className='h-20 bg-blue-100 border-2 border-dashed flex justify-center items-center cursor-pointer'>
               Add address
            </div>
      </div>
